        ...
        <Box>
            <Paper sx={{ width: 250, marginBottom: 10 }} elevation={3}>
                <Grid container direction="column" alignItems="center" justifyContent="center" rowGap={2}>
                    ...
                    <Box
                        component="img"
                        sx={{ width: 250, height: 120, objectFit: "cover" }}
                        src={adoptionCenter.centerImageUrl}
                        alt="Adoption center image"
                    />
                    ...
                    <Grid container direction="column" alignItems="center" justifyContent="center" rowGap={2}>
                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                            <Button
                                ...
                                color="primary"
                                onClick={() => {
                                    const profilePageUrl = `/adoption-center-home/${adoptionCenter.centerId}`;
                                    navigateTo(profilePageUrl);
                                }}
                            >
                                Go to Homepage
                            </Button>
